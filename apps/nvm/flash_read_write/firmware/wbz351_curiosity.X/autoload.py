...
def header_copyright():
    print("Header GUI v1.04 (c) 12/20/2021 Microchip Technology All Rights Reserved")
def ota_copyright():
    print("Over The Air Package Maker GUI v1.03 (c) 12/20/2021 Microchip Technology All Rights Reserved")
...
def write_ota_config_file():
    ...
    settings.setString("configuration.header.bota_flash_id", zotaOpt.flashImgIDTxt.getText())
