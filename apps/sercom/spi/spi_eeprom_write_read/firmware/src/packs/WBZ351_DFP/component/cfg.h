...
#define CFG_CFGCON0_ACCMP1_ALTEN(value)       (CFG_CFGCON0_ACCMP1_ALTEN_Msk & (_UINT32_(value) << CFG_CFGCON0_ACCMP1_ALTEN_Pos)) /* Assignment of value for ACCMP1_ALTEN in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_SMBUSEN0(value)           (CFG_CFGCON0_SMBUSEN0_Msk & (_UINT32_(value) << CFG_CFGCON0_SMBUSEN0_Pos)) /* Assignment of value for SMBUSEN0 in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_SMBUSEN1(value)           (CFG_CFGCON0_SMBUSEN1_Msk & (_UINT32_(value) << CFG_CFGCON0_SMBUSEN1_Pos)) /* Assignment of value for SMBUSEN1 in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_SLRTEN0(value)            (CFG_CFGCON0_SLRTEN0_Msk & (_UINT32_(value) << CFG_CFGCON0_SLRTEN0_Pos)) /* Assignment of value for SLRTEN0 in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_SLRTEN1(value)            (CFG_CFGCON0_SLRTEN1_Msk & (_UINT32_(value) << CFG_CFGCON0_SLRTEN1_Pos)) /* Assignment of value for SLRTEN1 in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_SLRTEN2(value)            (CFG_CFGCON0_SLRTEN2_Msk & (_UINT32_(value) << CFG_CFGCON0_SLRTEN2_Pos)) /* Assignment of value for SLRTEN2 in the CFG_CFGCON0 register */
...
#define CFG_CFGCON1_ECC_SEL_MEM(value)        (CFG_CFGCON1_ECC_SEL_MEM_Msk & (_UINT32_(value) << CFG_CFGCON1_ECC_SEL_MEM_Pos)) /* Assignment of value for ECC_SEL_MEM in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_SLRCTRL0(value)           (CFG_CFGCON1_SLRCTRL0_Msk & (_UINT32_(value) << CFG_CFGCON1_SLRCTRL0_Pos)) /* Assignment of value for SLRCTRL0 in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_SLRCTRL1(value)           (CFG_CFGCON1_SLRCTRL1_Msk & (_UINT32_(value) << CFG_CFGCON1_SLRCTRL1_Pos)) /* Assignment of value for SLRCTRL1 in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_SLRCTRL2(value)           (CFG_CFGCON1_SLRCTRL2_Msk & (_UINT32_(value) << CFG_CFGCON1_SLRCTRL2_Pos)) /* Assignment of value for SLRCTRL2 in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_I2CDSEL0(value)           (CFG_CFGCON1_I2CDSEL0_Msk & (_UINT32_(value) << CFG_CFGCON1_I2CDSEL0_Pos)) /* Assignment of value for I2CDSEL0 in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_I2CDSEL1(value)           (CFG_CFGCON1_I2CDSEL1_Msk & (_UINT32_(value) << CFG_CFGCON1_I2CDSEL1_Pos)) /* Assignment of value for I2CDSEL1 in the CFG_CFGCON1 register */
...
#define CFG_CFGCON1_I2CDSEL2(value)           (CFG_CFGCON1_I2CDSEL2_Msk & (_UINT32_(value) << CFG_CFGCON1_I2CDSEL2_Pos)) /* Assignment of value for I2CDSEL2 in the CFG_CFGCON1 register */
...
#define CFG_CFGPGQOS_CPUPG(value)             (CFG_CFGPGQOS_CPUPG_Msk & (_UINT32_(value) << CFG_CFGPGQOS_CPUPG_Pos)) /* Assignment of value for CPUPG in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_CPUQOS(value)            (CFG_CFGPGQOS_CPUQOS_Msk & (_UINT32_(value) << CFG_CFGPGQOS_CPUQOS_Pos)) /* Assignment of value for CPUQOS in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_DMAPG(value)             (CFG_CFGPGQOS_DMAPG_Msk & (_UINT32_(value) << CFG_CFGPGQOS_DMAPG_Pos)) /* Assignment of value for DMAPG in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_DGISPIPG(value)          (CFG_CFGPGQOS_DGISPIPG_Msk & (_UINT32_(value) << CFG_CFGPGQOS_DGISPIPG_Pos)) /* Assignment of value for DGISPIPG in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_DGISPIQOS(value)         (CFG_CFGPGQOS_DGISPIQOS_Msk & (_UINT32_(value) << CFG_CFGPGQOS_DGISPIQOS_Pos)) /* Assignment of value for DGISPIQOS in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_CRYPTOPG(value)          (CFG_CFGPGQOS_CRYPTOPG_Msk & (_UINT32_(value) << CFG_CFGPGQOS_CRYPTOPG_Pos)) /* Assignment of value for CRYPTOPG in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_CRYPTOQOS(value)         (CFG_CFGPGQOS_CRYPTOQOS_Msk & (_UINT32_(value) << CFG_CFGPGQOS_CRYPTOQOS_Pos)) /* Assignment of value for CRYPTOQOS in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_DSUPG(value)             (CFG_CFGPGQOS_DSUPG_Msk & (_UINT32_(value) << CFG_CFGPGQOS_DSUPG_Pos)) /* Assignment of value for DSUPG in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_FCQOS(value)             (CFG_CFGPGQOS_FCQOS_Msk & (_UINT32_(value) << CFG_CFGPGQOS_FCQOS_Pos)) /* Assignment of value for FCQOS in the CFG_CFGPGQOS register */
...
#define CFG_CFGPGQOS_WISIBQOS(value)          (CFG_CFGPGQOS_WISIBQOS_Msk & (_UINT32_(value) << CFG_CFGPGQOS_WISIBQOS_Pos)) /* Assignment of value for WISIBQOS in the CFG_CFGPGQOS register */
...
#define CFG_CFGPCLKGEN1_SERCOM01CSEL(value)   (CFG_CFGPCLKGEN1_SERCOM01CSEL_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN1_SERCOM01CSEL_Pos)) /* Assignment of value for SERCOM01CSEL in the CFG_CFGPCLKGEN1 register */
...
#define CFG_CFGPCLKGEN1_SERCOM01CD(value)     (CFG_CFGPCLKGEN1_SERCOM01CD_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN1_SERCOM01CD_Pos)) /* Assignment of value for SERCOM01CD in the CFG_CFGPCLKGEN1 register */
...
#define CFG_CFGPCLKGEN1_SERCOM2CSEL(value)    (CFG_CFGPCLKGEN1_SERCOM2CSEL_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN1_SERCOM2CSEL_Pos)) /* Assignment of value for SERCOM2CSEL in the CFG_CFGPCLKGEN1 register */
...
#define CFG_CFGPCLKGEN1_SERCOM2CD(value)      (CFG_CFGPCLKGEN1_SERCOM2CD_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN1_SERCOM2CD_Pos)) /* Assignment of value for SERCOM2CD in the CFG_CFGPCLKGEN1 register */
...
#define CFG_CFGPCLKGEN4_TC54CSEL(value)       (CFG_CFGPCLKGEN4_TC54CSEL_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN4_TC54CSEL_Pos)) /* Assignment of value for TC54CSEL in the CFG_CFGPCLKGEN4 register */
...
#define CFG_CFGPCLKGEN4_TC54CD(value)         (CFG_CFGPCLKGEN4_TC54CD_Msk & (_UINT32_(value) << CFG_CFGPCLKGEN4_TC54CD_Pos)) /* Assignment of value for TC54CD in the CFG_CFGPCLKGEN4 register */
...
#define CFG_PMD1_ZBMD(value)                  (CFG_PMD1_ZBMD_Msk & (_UINT32_(value) << CFG_PMD1_ZBMD_Pos)) /* Assignment of value for ZBMD in the CFG_PMD1 register */
...
#define CFG_PMD1_BTMD(value)                  (CFG_PMD1_BTMD_Msk & (_UINT32_(value) << CFG_PMD1_BTMD_Pos)) /* Assignment of value for BTMD in the CFG_PMD1 register */
...
#define CFG_PMD1_MPAMD(value)                 (CFG_PMD1_MPAMD_Msk & (_UINT32_(value) << CFG_PMD1_MPAMD_Pos)) /* Assignment of value for MPAMD in the CFG_PMD1 register */
...
#define CFG_PMD1_LPAMD(value)                 (CFG_PMD1_LPAMD_Msk & (_UINT32_(value) << CFG_PMD1_LPAMD_Pos)) /* Assignment of value for LPAMD in the CFG_PMD1 register */
...
#define CFG_PMD1_PLVDMD(value)                (CFG_PMD1_PLVDMD_Msk & (_UINT32_(value) << CFG_PMD1_PLVDMD_Pos)) /* Assignment of value for PLVDMD in the CFG_PMD1 register */
...
#define CFG_PMD1_DGISPIMD(value)              (CFG_PMD1_DGISPIMD_Msk & (_UINT32_(value) << CFG_PMD1_DGISPIMD_Pos)) /* Assignment of value for DGISPIMD in the CFG_PMD1 register */
...
#define CFG_PMD1_QSPIMD(value)                (CFG_PMD1_QSPIMD_Msk & (_UINT32_(value) << CFG_PMD1_QSPIMD_Pos)) /* Assignment of value for QSPIMD in the CFG_PMD1 register */
...
#define CFG_PMD3_DACMD(value)                 (CFG_PMD3_DACMD_Msk & (_UINT32_(value) << CFG_PMD3_DACMD_Pos)) /* Assignment of value for DACMD in the CFG_PMD3 register */
