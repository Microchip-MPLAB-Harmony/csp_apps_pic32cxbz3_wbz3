...
- Connect I2C SDA line (pin 11 of Xpro Header) and I2C SCL line (pin 12 of Xpro Header) of the curiosity board with the corresponding SDA and SCL lines of the I2C master
- Connect a ground wire from the curiosity board (pin 19 of Xpro Header) to the ground of the I2C master
