...
#define DGI_SPI_SPICON_GO(value)              (DGI_SPI_SPICON_GO_Msk & (_UINT32_(value) << DGI_SPI_SPICON_GO_Pos)) /* Assignment of value for GO in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_STXISEL(value)         (DGI_SPI_SPICON_STXISEL_Msk & (_UINT32_(value) << DGI_SPI_SPICON_STXISEL_Pos)) /* Assignment of value for STXISEL in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_CKP(value)             (DGI_SPI_SPICON_CKP_Msk & (_UINT32_(value) << DGI_SPI_SPICON_CKP_Pos)) /* Assignment of value for CKP in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_SSCON(value)           (DGI_SPI_SPICON_SSCON_Msk & (_UINT32_(value) << DGI_SPI_SPICON_SSCON_Pos)) /* Assignment of value for SSCON in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_CKE(value)             (DGI_SPI_SPICON_CKE_Msk & (_UINT32_(value) << DGI_SPI_SPICON_CKE_Pos)) /* Assignment of value for CKE in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_MODE(value)            (DGI_SPI_SPICON_MODE_Msk & (_UINT32_(value) << DGI_SPI_SPICON_MODE_Pos)) /* Assignment of value for MODE in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_DISSDO(value)          (DGI_SPI_SPICON_DISSDO_Msk & (_UINT32_(value) << DGI_SPI_SPICON_DISSDO_Pos)) /* Assignment of value for DISSDO in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_SIDL(value)            (DGI_SPI_SPICON_SIDL_Msk & (_UINT32_(value) << DGI_SPI_SPICON_SIDL_Pos)) /* Assignment of value for SIDL in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_FRZ(value)             (DGI_SPI_SPICON_FRZ_Msk & (_UINT32_(value) << DGI_SPI_SPICON_FRZ_Pos)) /* Assignment of value for FRZ in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_ON(value)              (DGI_SPI_SPICON_ON_Msk & (_UINT32_(value) << DGI_SPI_SPICON_ON_Pos)) /* Assignment of value for ON in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_ENHBUF(value)          (DGI_SPI_SPICON_ENHBUF_Msk & (_UINT32_(value) << DGI_SPI_SPICON_ENHBUF_Pos)) /* Assignment of value for ENHBUF in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_MCLKEN(value)          (DGI_SPI_SPICON_MCLKEN_Msk & (_UINT32_(value) << DGI_SPI_SPICON_MCLKEN_Pos)) /* Assignment of value for MCLKEN in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPICON_MSSEN(value)           (DGI_SPI_SPICON_MSSEN_Msk & (_UINT32_(value) << DGI_SPI_SPICON_MSSEN_Pos)) /* Assignment of value for MSSEN in the DGI_SPI_SPICON register */
...
#define DGI_SPI_SPISTAT_SPITBF(value)         (DGI_SPI_SPISTAT_SPITBF_Msk & (_UINT32_(value) << DGI_SPI_SPISTAT_SPITBF_Pos)) /* Assignment of value for SPITBF in the DGI_SPI_SPISTAT register */
...
#define DGI_SPI_SPISTAT_SPITBE(value)         (DGI_SPI_SPISTAT_SPITBE_Msk & (_UINT32_(value) << DGI_SPI_SPISTAT_SPITBE_Pos)) /* Assignment of value for SPITBE in the DGI_SPI_SPISTAT register */
...
#define DGI_SPI_SPISTAT_SRMT(value)           (DGI_SPI_SPISTAT_SRMT_Msk & (_UINT32_(value) << DGI_SPI_SPISTAT_SRMT_Pos)) /* Assignment of value for SRMT in the DGI_SPI_SPISTAT register */
...
#define DGI_SPI_SPISTAT_SPIBUSY(value)        (DGI_SPI_SPISTAT_SPIBUSY_Msk & (_UINT32_(value) << DGI_SPI_SPISTAT_SPIBUSY_Pos)) /* Assignment of value for SPIBUSY in the DGI_SPI_SPISTAT register */
...
#define DGI_SPI_SPISTAT_TXBUFELM(value)       (DGI_SPI_SPISTAT_TXBUFELM_Msk & (_UINT32_(value) << DGI_SPI_SPISTAT_TXBUFELM_Pos)) /* Assignment of value for TXBUFELM in the DGI_SPI_SPISTAT register */
