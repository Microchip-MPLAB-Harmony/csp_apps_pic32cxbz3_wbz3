...
#define PMU_PMUCMODE_CVREG2OCTROL(value)      (PMU_PMUCMODE_CVREG2OCTROL_Msk & (_UINT32_(value) << PMU_PMUCMODE_CVREG2OCTROL_Pos)) /* Assignment of value for CVREG2OCTROL in the PMU_PMUCMODE register */
...
#define PMU_WCMCFG_WCM1CFG(value)             (PMU_WCMCFG_WCM1CFG_Msk & (_UINT32_(value) << PMU_WCMCFG_WCM1CFG_Pos)) /* Assignment of value for WCM1CFG in the PMU_WCMCFG register */
...
#define PMU_WCMCFG_WCM2CFG(value)             (PMU_WCMCFG_WCM2CFG_Msk & (_UINT32_(value) << PMU_WCMCFG_WCM2CFG_Pos)) /* Assignment of value for WCM2CFG in the PMU_WCMCFG register */
...
#define   PMU_WCMSIZ_SRAM1_SIZ_NO_SRAM_RETENTION_Val _UINT32_(0x0)                                        /* (PMU_WCMSIZ) FlexRAM is completely powered OFF  */
...
#define   PMU_WCMSIZ_SRAM1_SIZ_RESERVED_Val   _UINT32_(0x3)                                        /* (PMU_WCMSIZ) Reserved  */
