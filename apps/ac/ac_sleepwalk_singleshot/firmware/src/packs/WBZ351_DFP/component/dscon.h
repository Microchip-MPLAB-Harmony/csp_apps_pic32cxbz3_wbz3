...
#ifndef _WBZ35_DSCON_COMPONENT_H_
#define _WBZ35_DSCON_COMPONENT_H_
...
#define DSCON_DSWAKE_ICD(value)               (DSCON_DSWAKE_ICD_Msk & (_UINT32_(value) << DSCON_DSWAKE_ICD_Pos)) /* Assignment of value for ICD in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_MCLR(value)              (DSCON_DSWAKE_MCLR_Msk & (_UINT32_(value) << DSCON_DSWAKE_MCLR_Pos)) /* Assignment of value for MCLR in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_RTCC(value)              (DSCON_DSWAKE_RTCC_Msk & (_UINT32_(value) << DSCON_DSWAKE_RTCC_Pos)) /* Assignment of value for RTCC in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_DSWDT(value)             (DSCON_DSWAKE_DSWDT_Msk & (_UINT32_(value) << DSCON_DSWAKE_DSWDT_Pos)) /* Assignment of value for DSWDT in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_EXT(value)               (DSCON_DSWAKE_EXT_Msk & (_UINT32_(value) << DSCON_DSWAKE_EXT_Pos)) /* Assignment of value for EXT in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_FAULT(value)             (DSCON_DSWAKE_FAULT_Msk & (_UINT32_(value) << DSCON_DSWAKE_FAULT_Pos)) /* Assignment of value for FAULT in the DSCON_DSWAKE register */
...
#define DSCON_DSWAKE_INT0(value)              (DSCON_DSWAKE_INT0_Msk & (_UINT32_(value) << DSCON_DSWAKE_INT0_Pos)) /* Assignment of value for INT0 in the DSCON_DSWAKE register */
...
#endif /* _WBZ35_DSCON_COMPONENT_H_ */
