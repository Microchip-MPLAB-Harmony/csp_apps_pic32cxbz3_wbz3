...
#define CRU_OSCCON_OSWEN(value)               (CRU_OSCCON_OSWEN_Msk & (_UINT32_(value) << CRU_OSCCON_OSWEN_Pos)) /* Assignment of value for OSWEN in the CRU_OSCCON register */
...
#define CRU_OSCCON_SOSCEN(value)              (CRU_OSCCON_SOSCEN_Msk & (_UINT32_(value) << CRU_OSCCON_SOSCEN_Pos)) /* Assignment of value for SOSCEN in the CRU_OSCCON register */
...
#define CRU_OSCCON_CF(value)                  (CRU_OSCCON_CF_Msk & (_UINT32_(value) << CRU_OSCCON_CF_Pos)) /* Assignment of value for CF in the CRU_OSCCON register */
...
#define CRU_OSCCON_SLPEN(value)               (CRU_OSCCON_SLPEN_Msk & (_UINT32_(value) << CRU_OSCCON_SLPEN_Pos)) /* Assignment of value for SLPEN in the CRU_OSCCON register */
...
#define CRU_OSCCON_CLKLOCK(value)             (CRU_OSCCON_CLKLOCK_Msk & (_UINT32_(value) << CRU_OSCCON_CLKLOCK_Pos)) /* Assignment of value for CLKLOCK in the CRU_OSCCON register */
...
#define CRU_OSCCON_NOSC(value)                (CRU_OSCCON_NOSC_Msk & (_UINT32_(value) << CRU_OSCCON_NOSC_Pos)) /* Assignment of value for NOSC in the CRU_OSCCON register */
...
#define CRU_OSCCON_COSC(value)                (CRU_OSCCON_COSC_Msk & (_UINT32_(value) << CRU_OSCCON_COSC_Pos)) /* Assignment of value for COSC in the CRU_OSCCON register */
...
#define CRU_OSCCON_WAKE2SPD(value)            (CRU_OSCCON_WAKE2SPD_Msk & (_UINT32_(value) << CRU_OSCCON_WAKE2SPD_Pos)) /* Assignment of value for WAKE2SPD in the CRU_OSCCON register */
...
#define CRU_OSCCON_DRMEN(value)               (CRU_OSCCON_DRMEN_Msk & (_UINT32_(value) << CRU_OSCCON_DRMEN_Pos)) /* Assignment of value for DRMEN in the CRU_OSCCON register */
...
#define CRU_OSCCON_FRCDIV(value)              (CRU_OSCCON_FRCDIV_Msk & (_UINT32_(value) << CRU_OSCCON_FRCDIV_Pos)) /* Assignment of value for FRCDIV in the CRU_OSCCON register */
...
#define CRU_OSCTUN_TUN(value)                 (CRU_OSCTUN_TUN_Msk & (_UINT32_(value) << CRU_OSCTUN_TUN_Pos)) /* Assignment of value for TUN in the CRU_OSCTUN register */
...
#define CRU_SPLLCON_RESETVALUE                _UINT32_(0xC0010028)                                 /*  (CRU_SPLLCON) SPLL CONTROL REGISTER  Reset Value */
...
#define CRU_SPLLCON_SPLLPWDN(value)           (CRU_SPLLCON_SPLLPWDN_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLLPWDN_Pos)) /* Assignment of value for SPLLPWDN in the CRU_SPLLCON register */
...
#define CRU_SPLLCON_SPLLFLOCK(value)          (CRU_SPLLCON_SPLLFLOCK_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLLFLOCK_Pos)) /* Assignment of value for SPLLFLOCK in the CRU_SPLLCON register */
...
#define CRU_SPLLCON_SPLLRST(value)            (CRU_SPLLCON_SPLLRST_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLLRST_Pos)) /* Assignment of value for SPLLRST in the CRU_SPLLCON register */
...
#define CRU_SPLLCON_SPLLPOSTDIV1(value)       (CRU_SPLLCON_SPLLPOSTDIV1_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLLPOSTDIV1_Pos)) /* Assignment of value for SPLLPOSTDIV1 in the CRU_SPLLCON register */
...
#define CRU_SPLLCON_SPLLPOSTDIV2(value)       (CRU_SPLLCON_SPLLPOSTDIV2_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLLPOSTDIV2_Pos)) /* Assignment of value for SPLLPOSTDIV2 in the CRU_SPLLCON register */
...
#define CRU_SPLLCON_SPLL_BYP(value)           (CRU_SPLLCON_SPLL_BYP_Msk & (_UINT32_(value) << CRU_SPLLCON_SPLL_BYP_Pos)) /* Assignment of value for SPLL_BYP in the CRU_SPLLCON register */
...
#define CRU_REFO1CON_ROSEL(value)             (CRU_REFO1CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO1CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_ACTIVE(value)            (CRU_REFO1CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO1CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_DIVSWEN(value)           (CRU_REFO1CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO1CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_RSLP(value)              (CRU_REFO1CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO1CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_OE(value)                (CRU_REFO1CON_OE_Msk & (_UINT32_(value) << CRU_REFO1CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_SIDL(value)              (CRU_REFO1CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO1CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_FRZ(value)               (CRU_REFO1CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO1CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_ON(value)                (CRU_REFO1CON_ON_Msk & (_UINT32_(value) << CRU_REFO1CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO1CON register */
...
#define CRU_REFO1CON_RODIV(value)             (CRU_REFO1CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO1CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO1CON register */
...
#define CRU_REFO1TRIM_ROTRIM(value)           (CRU_REFO1TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO1TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO1TRIM register */
...
#define CRU_REFO2CON_ROSEL(value)             (CRU_REFO2CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO2CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_ACTIVE(value)            (CRU_REFO2CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO2CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_DIVSWEN(value)           (CRU_REFO2CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO2CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_RSLP(value)              (CRU_REFO2CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO2CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_OE(value)                (CRU_REFO2CON_OE_Msk & (_UINT32_(value) << CRU_REFO2CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_SIDL(value)              (CRU_REFO2CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO2CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_FRZ(value)               (CRU_REFO2CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO2CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_ON(value)                (CRU_REFO2CON_ON_Msk & (_UINT32_(value) << CRU_REFO2CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO2CON register */
...
#define CRU_REFO2CON_RODIV(value)             (CRU_REFO2CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO2CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO2CON register */
...
#define CRU_REFO2TRIM_ROTRIM(value)           (CRU_REFO2TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO2TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO2TRIM register */
...
#define CRU_REFO3CON_ROSEL(value)             (CRU_REFO3CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO3CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_ACTIVE(value)            (CRU_REFO3CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO3CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_DIVSWEN(value)           (CRU_REFO3CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO3CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_RSLP(value)              (CRU_REFO3CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO3CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_OE(value)                (CRU_REFO3CON_OE_Msk & (_UINT32_(value) << CRU_REFO3CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_SIDL(value)              (CRU_REFO3CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO3CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_FRZ(value)               (CRU_REFO3CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO3CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_ON(value)                (CRU_REFO3CON_ON_Msk & (_UINT32_(value) << CRU_REFO3CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO3CON register */
...
#define CRU_REFO3CON_RODIV(value)             (CRU_REFO3CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO3CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO3CON register */
...
#define CRU_REFO3TRIM_ROTRIM(value)           (CRU_REFO3TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO3TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO3TRIM register */
...
#define CRU_REFO4CON_ROSEL(value)             (CRU_REFO4CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO4CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_ACTIVE(value)            (CRU_REFO4CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO4CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_DIVSWEN(value)           (CRU_REFO4CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO4CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_RSLP(value)              (CRU_REFO4CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO4CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_OE(value)                (CRU_REFO4CON_OE_Msk & (_UINT32_(value) << CRU_REFO4CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_SIDL(value)              (CRU_REFO4CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO4CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_FRZ(value)               (CRU_REFO4CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO4CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_ON(value)                (CRU_REFO4CON_ON_Msk & (_UINT32_(value) << CRU_REFO4CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO4CON register */
...
#define CRU_REFO4CON_RODIV(value)             (CRU_REFO4CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO4CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO4CON register */
...
#define CRU_REFO4TRIM_ROTRIM(value)           (CRU_REFO4TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO4TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO4TRIM register */
...
#define CRU_REFO5CON_ROSEL(value)             (CRU_REFO5CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO5CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_ACTIVE(value)            (CRU_REFO5CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO5CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_DIVSWEN(value)           (CRU_REFO5CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO5CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_RSLP(value)              (CRU_REFO5CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO5CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_OE(value)                (CRU_REFO5CON_OE_Msk & (_UINT32_(value) << CRU_REFO5CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_SIDL(value)              (CRU_REFO5CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO5CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_FRZ(value)               (CRU_REFO5CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO5CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_ON(value)                (CRU_REFO5CON_ON_Msk & (_UINT32_(value) << CRU_REFO5CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO5CON register */
...
#define CRU_REFO5CON_RODIV(value)             (CRU_REFO5CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO5CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO5CON register */
...
#define CRU_REFO5TRIM_ROTRIM(value)           (CRU_REFO5TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO5TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO5TRIM register */
...
#define CRU_REFO6CON_ROSEL(value)             (CRU_REFO6CON_ROSEL_Msk & (_UINT32_(value) << CRU_REFO6CON_ROSEL_Pos)) /* Assignment of value for ROSEL in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_ACTIVE(value)            (CRU_REFO6CON_ACTIVE_Msk & (_UINT32_(value) << CRU_REFO6CON_ACTIVE_Pos)) /* Assignment of value for ACTIVE in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_DIVSWEN(value)           (CRU_REFO6CON_DIVSWEN_Msk & (_UINT32_(value) << CRU_REFO6CON_DIVSWEN_Pos)) /* Assignment of value for DIVSWEN in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_RSLP(value)              (CRU_REFO6CON_RSLP_Msk & (_UINT32_(value) << CRU_REFO6CON_RSLP_Pos)) /* Assignment of value for RSLP in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_OE(value)                (CRU_REFO6CON_OE_Msk & (_UINT32_(value) << CRU_REFO6CON_OE_Pos)) /* Assignment of value for OE in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_SIDL(value)              (CRU_REFO6CON_SIDL_Msk & (_UINT32_(value) << CRU_REFO6CON_SIDL_Pos)) /* Assignment of value for SIDL in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_FRZ(value)               (CRU_REFO6CON_FRZ_Msk & (_UINT32_(value) << CRU_REFO6CON_FRZ_Pos)) /* Assignment of value for FRZ in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_ON(value)                (CRU_REFO6CON_ON_Msk & (_UINT32_(value) << CRU_REFO6CON_ON_Pos)) /* Assignment of value for ON in the CRU_REFO6CON register */
...
#define CRU_REFO6CON_RODIV(value)             (CRU_REFO6CON_RODIV_Msk & (_UINT32_(value) << CRU_REFO6CON_RODIV_Pos)) /* Assignment of value for RODIV in the CRU_REFO6CON register */
...
#define CRU_REFO6TRIM_ROTRIM(value)           (CRU_REFO6TRIM_ROTRIM_Msk & (_UINT32_(value) << CRU_REFO6TRIM_ROTRIM_Pos)) /* Assignment of value for ROTRIM in the CRU_REFO6TRIM register */
...
#define CRU_PB1DIV_RESETVALUE                 _UINT32_(0x8800)                                     /*  (CRU_PB1DIV) PB1 CLOCK DIVISOR CONTROL REGISTER  Reset Value */
...
#define CRU_PB1DIV_PBDIV(value)               (CRU_PB1DIV_PBDIV_Msk & (_UINT32_(value) << CRU_PB1DIV_PBDIV_Pos)) /* Assignment of value for PBDIV in the CRU_PB1DIV register */
...
#define CRU_PB1DIV_PBDIVRDY(value)            (CRU_PB1DIV_PBDIVRDY_Msk & (_UINT32_(value) << CRU_PB1DIV_PBDIVRDY_Pos)) /* Assignment of value for PBDIVRDY in the CRU_PB1DIV register */
...
#define CRU_PB1DIV_PBDIVON(value)             (CRU_PB1DIV_PBDIVON_Msk & (_UINT32_(value) << CRU_PB1DIV_PBDIVON_Pos)) /* Assignment of value for PBDIVON in the CRU_PB1DIV register */
...
#define CRU_PB2DIV_PBDIV(value)               (CRU_PB2DIV_PBDIV_Msk & (_UINT32_(value) << CRU_PB2DIV_PBDIV_Pos)) /* Assignment of value for PBDIV in the CRU_PB2DIV register */
...
#define CRU_PB2DIV_PBDIVRDY(value)            (CRU_PB2DIV_PBDIVRDY_Msk & (_UINT32_(value) << CRU_PB2DIV_PBDIVRDY_Pos)) /* Assignment of value for PBDIVRDY in the CRU_PB2DIV register */
...
#define CRU_PB2DIV_PBDIVON(value)             (CRU_PB2DIV_PBDIVON_Msk & (_UINT32_(value) << CRU_PB2DIV_PBDIVON_Pos)) /* Assignment of value for PBDIVON in the CRU_PB2DIV register */
...
#define CRU_PB3DIV_PBDIV(value)               (CRU_PB3DIV_PBDIV_Msk & (_UINT32_(value) << CRU_PB3DIV_PBDIV_Pos)) /* Assignment of value for PBDIV in the CRU_PB3DIV register */
...
#define CRU_PB3DIV_PBDIVRDY(value)            (CRU_PB3DIV_PBDIVRDY_Msk & (_UINT32_(value) << CRU_PB3DIV_PBDIVRDY_Pos)) /* Assignment of value for PBDIVRDY in the CRU_PB3DIV register */
...
#define CRU_PB3DIV_PBDIVON(value)             (CRU_PB3DIV_PBDIVON_Msk & (_UINT32_(value) << CRU_PB3DIV_PBDIVON_Pos)) /* Assignment of value for PBDIVON in the CRU_PB3DIV register */
...
#define CRU_SLEWCON_BUSY(value)               (CRU_SLEWCON_BUSY_Msk & (_UINT32_(value) << CRU_SLEWCON_BUSY_Pos)) /* Assignment of value for BUSY in the CRU_SLEWCON register */
...
#define CRU_SLEWCON_DNEN(value)               (CRU_SLEWCON_DNEN_Msk & (_UINT32_(value) << CRU_SLEWCON_DNEN_Pos)) /* Assignment of value for DNEN in the CRU_SLEWCON register */
...
#define CRU_SLEWCON_UPEN(value)               (CRU_SLEWCON_UPEN_Msk & (_UINT32_(value) << CRU_SLEWCON_UPEN_Pos)) /* Assignment of value for UPEN in the CRU_SLEWCON register */
...
#define CRU_SLEWCON_SLWDIV(value)             (CRU_SLEWCON_SLWDIV_Msk & (_UINT32_(value) << CRU_SLEWCON_SLWDIV_Pos)) /* Assignment of value for SLWDIV in the CRU_SLEWCON register */
...
#define CRU_SLEWCON_SYSDIV(value)             (CRU_SLEWCON_SYSDIV_Msk & (_UINT32_(value) << CRU_SLEWCON_SYSDIV_Pos)) /* Assignment of value for SYSDIV in the CRU_SLEWCON register */
...
#define CRU_SLEWCON_SLWDLY(value)             (CRU_SLEWCON_SLWDLY_Msk & (_UINT32_(value) << CRU_SLEWCON_SLWDLY_Pos)) /* Assignment of value for SLWDLY in the CRU_SLEWCON register */
...
#define CRU_CLKSTAT_FRCRDY(value)             (CRU_CLKSTAT_FRCRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_FRCRDY_Pos)) /* Assignment of value for FRCRDY in the CRU_CLKSTAT register */
...
#define CRU_CLKSTAT_SPLL1RDY(value)           (CRU_CLKSTAT_SPLL1RDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_SPLL1RDY_Pos)) /* Assignment of value for SPLL1RDY in the CRU_CLKSTAT register */
...
#define CRU_CLKSTAT_POSCRDY(value)            (CRU_CLKSTAT_POSCRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_POSCRDY_Pos)) /* Assignment of value for POSCRDY in the CRU_CLKSTAT register */
...
#define CRU_CLKSTAT_SOSCRDY(value)            (CRU_CLKSTAT_SOSCRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_SOSCRDY_Pos)) /* Assignment of value for SOSCRDY in the CRU_CLKSTAT register */
...
#define CRU_CLKSTAT_LPRCRDY(value)            (CRU_CLKSTAT_LPRCRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_LPRCRDY_Pos)) /* Assignment of value for LPRCRDY in the CRU_CLKSTAT register */
...
#define CRU_CLKSTAT_SPLL3RDY(value)           (CRU_CLKSTAT_SPLL3RDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_SPLL3RDY_Pos)) /* Assignment of value for SPLL3RDY in the CRU_CLKSTAT register */
...
#define CRU_CLKDIAG_POSCSTOP(value)           (CRU_CLKDIAG_POSCSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_POSCSTOP_Pos)) /* Assignment of value for POSCSTOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_SOSCSTOP(value)           (CRU_CLKDIAG_SOSCSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_SOSCSTOP_Pos)) /* Assignment of value for SOSCSTOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_FRCSTOP(value)            (CRU_CLKDIAG_FRCSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_FRCSTOP_Pos)) /* Assignment of value for FRCSTOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_LPRCSTOP(value)           (CRU_CLKDIAG_LPRCSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_LPRCSTOP_Pos)) /* Assignment of value for LPRCSTOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_SPLL1STOP(value)          (CRU_CLKDIAG_SPLL1STOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_SPLL1STOP_Pos)) /* Assignment of value for SPLL1STOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_SPLL3STOP(value)          (CRU_CLKDIAG_SPLL3STOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_SPLL3STOP_Pos)) /* Assignment of value for SPLL3STOP in the CRU_CLKDIAG register */
...
#define CRU_CLKDIAG_NMICNT(value)             (CRU_CLKDIAG_NMICNT_Msk & (_UINT32_(value) << CRU_CLKDIAG_NMICNT_Pos)) /* Assignment of value for NMICNT in the CRU_CLKDIAG register */
#define CRU_CLKDIAG_Msk                       _UINT32_(0xFFFF003F)                                 /* (CRU_CLKDIAG) Register Mask  */


/* CRU register offsets definitions */
