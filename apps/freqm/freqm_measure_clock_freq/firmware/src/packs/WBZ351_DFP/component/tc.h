...
#ifndef _WBZ35_TC_COMPONENT_H_
#define _WBZ35_TC_COMPONENT_H_
...
#define TC_CTRLA_DMAOS(value)                 (TC_CTRLA_DMAOS_Msk & (_UINT32_(value) << TC_CTRLA_DMAOS_Pos)) /* Assignment of value for DMAOS in the TC_CTRLA register */
